...
$q = $koneksi->query("SELECT * FROM agama");
    ...
    ?>                
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary"><a href="tambah-agama.php" class="btn" style="background: #37306B; font-weight: bold; color:white; border-radius: 18px;"><i class="fa-solid fa-plus"></i> Tambah Data Agama</a></h6>
                        </div>
                        <div class="card-body">
